...
`,Iu=/(.+)!([^/]+)\/?([isu]+)?/,je=null,hi=null,tt=class t{static build(e,n){return pi(n),hi(e,n,r=>new t(je.new(e,r,n)))}static enumerateMethods(e,n,r){pi(r);let o=e.match(Iu);if(o===null)throw new Error("Invalid query; format is: class!method -- see documentation of Java.enumerateMethods(query) for details");let i=Memory.allocUtf8String(o[1]),s=Memory.allocUtf8String(o[2]),l=!1,a=!1,c=!1,d=o[3];d!==void 0&&(l=d.indexOf("s")!==-1,a=d.indexOf("i")!==-1,c=d.indexOf("u")!==-1);let p;if(n.jvmti!==null){let h=je.enumerateMethodsJvm(i,s,ft(l),ft(a),ft(c),r);try{p=JSON.parse(h.readUtf8String()).map(u=>{let g=ptr(u.loader);return u.loader=g.isNull()?null:g,u})}finally{je.dealloc(h)}}else Oe(r.vm,r,h=>{let u=je.enumerateMethodsArt(i,s,ft(l),ft(a),ft(c));try{let g=n["art::JavaVMExt::AddGlobalRef"],{vm:_}=n;p=JSON.parse(u.readUtf8String()).map(y=>{let v=y.loader;return y.loader=v!==0?g(_,h,ptr(v)):null,y})}finally{je.dealloc(u)}});return p}constructor(e){this.handle=e}has(e){return je.has(this.handle,Memory.allocUtf8String(e))!==0}find(e){return je.find(this.handle,Memory.allocUtf8String(e)).readUtf8String()}list(){let e=je.list(this.handle);try{return JSON.parse(e.readUtf8String())}finally{je.dealloc(e)}}};function pi(t){je===null&&(je=Nu(t),hi=Tu(je,t.vm))}function Nu(t){let e=Ot(),{jvmti:n=null}=e,{pointerSize:r}=Process,o=8,i=r,s=7*r,l=10*4+5*r,a=o+i+s+l,d=Memory.alloc(a),p=d.add(o),h=p.add(i),{getDeclaredMethods:u,getDeclaredFields:g}=t.javaLangClass(),_=t.javaLangReflectMethod(),y=t.javaLangReflectField(),v=h;[n!==null?n:NULL,u,g,_.getName,_.getModifiers,y.getName,y.getModifiers].forEach(A=>{v=v.writePointer(A).add(r)});let S=h.add(s),{vm:C}=t;if(e.flavor==="art"){let A;if(n!==null)A=[0,0,0,0];else{let D=yr(C).offset;A=[D.ifields,D.methods,D.sfields,D.copiedMethodsOffset]}let j=Ne(C),k=sn(C),M=S;[1,...A,j.size,j.offset.accessFlags,k.size,k.offset.accessFlags,4294967295].forEach(D=>{M=M.writeUInt(D).add(4)}),[e.artClassLinker.address,e["art::ClassLinker::VisitClasses"],e["art::mirror::Class::GetDescriptor"],e["art::ArtMethod::PrettyMethod"],Process.getModuleByName("libc.so").getExportByName("free")].forEach((D,N)=>{D===void 0&&(D=NULL),M=M.writePointer(D).add(r)})}let x=new CModule(ku,{lock:d,models:p,java_api:h,art_api:S}),L={exceptions:"propagate"},F={exceptions:"propagate",scheduling:"exclusive"};return{handle:x,new:new NativeFunction(x.model_new,"pointer",["pointer","pointer","pointer"],L),has:new NativeFunction(x.model_has,"bool",["pointer","pointer"],F),find:new NativeFunction(x.model_find,"pointer",["pointer","pointer"],F),list:new NativeFunction(x.model_list,"pointer",["pointer"],F),enumerateMethodsArt:new NativeFunction(x.enumerate_methods_art,"pointer",["pointer","pointer","bool","bool","bool"],L),enumerateMethodsJvm:new NativeFunction(x.enumerate_methods_jvm,"pointer",["pointer","pointer","bool","bool","bool","pointer"],L),dealloc:new NativeFunction(x.dealloc,"void",["pointer"],F)}}function Tu(t,e){let n=Ot();if(n.flavor!=="art")return xu;let r=n["art::JavaVMExt::DecodeGlobal"];return function(o,i,s){let l;return Oe(e,i,a=>{let c=r(e,a,o);l=s(c)}),l}}function xu(t,e,n){return n(NULL)}function ft(t){return t?1:0}var jt=class{constructor(e,n){this.items=new Map,this.capacity=e,this.destroy=n}dispose(e){let{items:n,destroy:r}=this;n.forEach(o=>{r(o,e)}),n.clear()}get(e){let{items:n}=this,r=n.get(e);return r!==void 0&&(n.delete(e),n.set(e,r)),r}set(e,n,r){let{items:o}=this,i=o.get(e);if(i!==void 0)o.delete(e),this.destroy(i,r);else if(o.size===this.capacity){let s=o.keys().next().value,l=o.get(s);o.delete(s),this.destroy(l,r)}o.set(e,n)}};var Pt=1,Rr=256,mi=65536,Lu=305419896,_i=32,gi=12,yi=8,bi=8,vi=4,Si=4,Ei=12,Mu=0,Au=1,Ou=2,ju=3,Pu=4,Ru=5,Fu=6,zu=4096,Du=4097,Uu=4099,Bu=8192,Vu=8193,Ju=8194,Gu=8195,Hu=8196,$u=8198,Zu=24,Wu=28,qu=2,Ku=24,wi=b.from([3,0,7,14,0]),jr="Ldalvik/annotation/Throws;",Qu=b.from([0]);function Yu(t){let e=new Fr,n=Object.assign({},t);return e.addClass(n),e.build()}var Fr=class{constructor(){this.classes=[]}addClass(e){this.classes.push(e)}build(){let e=tf(this.classes),{classes:n,interfaces:r,fields:o,methods:i,protos:s,parameters:l,annotationDirectories:a,annotationSets:c,throwsAnnotations:d,types:p,strings:h}=e,u=0,g=0,_=8,y=12,v=20,S=112;u+=S;let C=u,x=h.length*Si;u+=x;let L=u,F=p.length*vi;u+=F;let A=u,j=s.length*gi;u+=j;let k=u,M=o.length*yi;u+=M;let D=u,N=i.length*bi;u+=N;let U=u,W=n.length*_i;u+=W;let q=u,T=c.map(P=>{let V=u;return P.offset=V,u+=4+P.items.length*4,V}),w=n.reduce((P,V)=>(V.classData.constructorMethods.forEach(oe=>{let[,le,ie]=oe;(le&Rr)===0&&ie>=0&&(oe.push(u),P.push({offset:u,superConstructor:ie}),u+=Ku)}),P),[]);a.forEach(P=>{P.offset=u,u+=16+P.methods.length*8});let J=r.map(P=>{u=Pr(u,4);let V=u;return P.offset=V,u+=4+2*P.types.length,V}),G=l.map(P=>{u=Pr(u,4);let V=u;return P.offset=V,u+=4+2*P.types.length,V}),K=[],B=h.map(P=>{let V=u,Y=b.from(Te(P.length)),oe=b.from(P,"utf8"),le=b.concat([Y,oe,Qu]);return K.push(le),u+=le.length,V}),Z=w.map(P=>{let V=u;return u+=wi.length,V}),X=d.map(P=>{let V=ef(P);return P.offset=u,u+=V.length,V}),H=n.map((P,V)=>{P.classData.offset=u;let Y=Xu(P);return u+=Y.length,Y}),ae=0,ge=0;u=Pr(u,4);let $=u,ce=r.length+l.length,xe=4+(o.length>0?1:0)+2+c.length+w.length+a.length+(ce>0?1:0)+1+Z.length+d.length+n.length+1,Le=4+xe*Ei;u+=Le;let Re=u-q,Ve=u,O=b.alloc(Ve);O.write(`dex
035`),O.writeUInt32LE(Ve,32),O.writeUInt32LE(S,36),O.writeUInt32LE(Lu,40),O.writeUInt32LE(ae,44),O.writeUInt32LE(ge,48),O.writeUInt32LE($,52),O.writeUInt32LE(h.length,56),O.writeUInt32LE(C,60),O.writeUInt32LE(p.length,64),O.writeUInt32LE(L,68),O.writeUInt32LE(s.length,72),O.writeUInt32LE(A,76),O.writeUInt32LE(o.length,80),O.writeUInt32LE(o.length>0?k:0,84),O.writeUInt32LE(i.length,88),O.writeUInt32LE(D,92),O.writeUInt32LE(n.length,96),O.writeUInt32LE(U,100),O.writeUInt32LE(Re,104),O.writeUInt32LE(q,108),B.forEach((P,V)=>{O.writeUInt32LE(P,C+V*Si)}),p.forEach((P,V)=>{O.writeUInt32LE(P,L+V*vi)}),s.forEach((P,V)=>{let[Y,oe,le]=P,ie=A+V*gi;O.writeUInt32LE(Y,ie),O.writeUInt32LE(oe,ie+4),O.writeUInt32LE(le!==null?le.offset:0,ie+8)}),o.forEach((P,V)=>{let[Y,oe,le]=P,ie=k+V*yi;O.writeUInt16LE(Y,ie),O.writeUInt16LE(oe,ie+2),O.writeUInt32LE(le,ie+4)}),i.forEach((P,V)=>{let[Y,oe,le]=P,ie=D+V*bi;O.writeUInt16LE(Y,ie),O.writeUInt16LE(oe,ie+2),O.writeUInt32LE(le,ie+4)}),n.forEach((P,V)=>{let{interfaces:Y,annotationsDirectory:oe}=P,le=Y!==null?Y.offset:0,ie=oe!==null?oe.offset:0,vt=0,Me=U+V*_i;O.writeUInt32LE(P.index,Me),O.writeUInt32LE(P.accessFlags,Me+4),O.writeUInt32LE(P.superClassIndex,Me+8),O.writeUInt32LE(le,Me+12),O.writeUInt32LE(P.sourceFileIndex,Me+16),O.writeUInt32LE(ie,Me+20),O.writeUInt32LE(P.classData.offset,Me+24),O.writeUInt32LE(vt,Me+28)}),c.forEach((P,V)=>{let{items:Y}=P,oe=T[V];O.writeUInt32LE(Y.length,oe),Y.forEach((le,ie)=>{O.writeUInt32LE(le.offset,oe+4+ie*4)})}),w.forEach((P,V)=>{let{offset:Y,superConstructor:oe}=P,le=1,ie=1,vt=1,Me=0,Bt=4;O.writeUInt16LE(le,Y),O.writeUInt16LE(ie,Y+2),O.writeUInt16LE(vt,Y+4),O.writeUInt16LE(Me,Y+6),O.writeUInt32LE(Z[V],Y+8),O.writeUInt32LE(Bt,Y+12),O.writeUInt16LE(4208,Y+16),O.writeUInt16LE(oe,Y+18),O.writeUInt16LE(0,Y+20),O.writeUInt16LE(14,Y+22)}),a.forEach(P=>{let V=P.offset,Y=0,oe=0,le=P.methods.length,ie=0;O.writeUInt32LE(Y,V),O.writeUInt32LE(oe,V+4),O.writeUInt32LE(le,V+8),O.writeUInt32LE(ie,V+12),P.methods.forEach((vt,Me)=>{let Bt=V+16+Me*8,[Ls,Ms]=vt;O.writeUInt32LE(Ls,Bt),O.writeUInt32LE(Ms.offset,Bt+4)})}),r.forEach((P,V)=>{let Y=J[V];O.writeUInt32LE(P.types.length,Y),P.types.forEach((oe,le)=>{O.writeUInt16LE(oe,Y+4+le*2)})}),l.forEach((P,V)=>{let Y=G[V];O.writeUInt32LE(P.types.length,Y),P.types.forEach((oe,le)=>{O.writeUInt16LE(oe,Y+4+le*2)})}),K.forEach((P,V)=>{P.copy(O,B[V])}),Z.forEach(P=>{wi.copy(O,P)}),X.forEach((P,V)=>{P.copy(O,d[V].offset)}),H.forEach((P,V)=>{P.copy(O,n[V].classData.offset)}),O.writeUInt32LE(xe,$);let ye=[[Mu,1,g],[Au,h.length,C],[Ou,p.length,L],[ju,s.length,A]];o.length>0&&ye.push([Pu,o.length,k]),ye.push([Ru,i.length,D]),ye.push([Fu,n.length,U]),c.forEach((P,V)=>{ye.push([Uu,P.items.length,T[V]])}),w.forEach(P=>{ye.push([Vu,1,P.offset])}),a.forEach(P=>{ye.push([$u,1,P.offset])}),ce>0&&ye.push([Du,ce,J.concat(G)[0]]),ye.push([Ju,h.length,B[0]]),Z.forEach(P=>{ye.push([Gu,1,P])}),d.forEach(P=>{ye.push([Hu,1,P.offset])}),n.forEach(P=>{ye.push([Bu,1,P.classData.offset])}),ye.push([zu,1,$]),ye.forEach((P,V)=>{let[Y,oe,le]=P,ie=$+4+V*Ei;O.writeUInt16LE(Y,ie),O.writeUInt32LE(oe,ie+4),O.writeUInt32LE(le,ie+8)});let so=new Checksum("sha1");return so.update(O.slice(y+v)),b.from(so.getDigest()).copy(O,y),O.writeUInt32LE(lf(O,y),_),O}};function Xu(t){let{instanceFields:e,constructorMethods:n,virtualMethods:r}=t.classData;return b.from([0].concat(Te(e.length)).concat(Te(n.length)).concat(Te(r.length)).concat(e.reduce((i,[s,l])=>i.concat(Te(s)).concat(Te(l)),[])).concat(n.reduce((i,[s,l,,a])=>i.concat(Te(s)).concat(Te(l)).concat(Te(a||0)),[])).concat(r.reduce((i,[s,l])=>i.concat(Te(s)).concat(Te(l)).concat([0]),[])))}function ef(t){let{thrownTypes:e}=t;return b.from([qu].concat(Te(t.type)).concat([1]).concat(Te(t.value)).concat([Wu,e.length]).concat(e.reduce((n,r)=>(n.push(Zu,r),n),[])))}function tf(t){let e=new Set,n=new Set,r={},o=[],i=[],s={},l=new Set,a=new Set;t.forEach(N=>{let{name:U,superClass:W,sourceFileName:q}=N;e.add("this"),e.add(U),n.add(U),e.add(W),n.add(W),e.add(q),N.interfaces.forEach(T=>{e.add(T),n.add(T)}),N.fields.forEach(T=>{let[w,J]=T;e.add(w),e.add(J),n.add(J),o.push([N.name,J,w])}),N.methods.some(([T])=>T==="<init>")||(N.methods.unshift(["<init>","V",[]]),l.add(U)),N.methods.forEach(T=>{let[w,J,G,K=[],B]=T;e.add(w);let Z=c(J,G),X=null;if(K.length>0){let H=K.slice();H.sort(),X=H.join("|");let ae=s[X];ae===void 0&&(ae={id:X,types:H},s[X]=ae),e.add(jr),n.add(jr),K.forEach(ge=>{e.add(ge),n.add(ge)}),e.add("value")}if(i.push([N.name,Z,w,X,B]),w==="<init>"){a.add(U+"|"+Z);let H=W+"|"+Z;l.has(U)&&!a.has(H)&&(i.push([W,Z,w,null,0]),a.add(H))}})});function c(N,U){let W=[N].concat(U),q=W.join("|");if(r[q]!==void 0)return q;e.add(N),n.add(N),U.forEach(w=>{e.add(w),n.add(w)});let T=W.map(af).join("");return e.add(T),r[q]=[q,T,N,U],q}let d=Array.from(e);d.sort();let p=d.reduce((N,U,W)=>(N[U]=W,N),{}),h=Array.from(n).map(N=>p[N]);h.sort(Ci);let u=h.reduce((N,U,W)=>(N[d[U]]=W,N),{}),g=Object.keys(r).map(N=>r[N]);g.sort(rf);let _={},y=g.map(N=>{let[,U,W,q]=N,T;if(q.length>0){let w=q.join("|");T=_[w],T===void 0&&(T={types:q.map(J=>u[J]),offset:-1},_[w]=T)}else T=null;return[p[U],u[W],T]}),v=g.reduce((N,U,W)=>{let[q]=U;return N[q]=W,N},{}),S=Object.keys(_).map(N=>_[N]),C=o.map(N=>{let[U,W,q]=N;return[u[U],u[W],p[q]]});C.sort(of);let x=i.map(N=>{let[U,W,q,T,w]=N;return[u[U],v[W],p[q],T,w]});x.sort(sf);let L=Object.keys(s).map(N=>s[N]).map(N=>({id:N.id,type:u[jr],value:p.value,thrownTypes:N.types.map(U=>u[U]),offset:-1})),F=L.map(N=>({id:N.id,items:[N],offset:-1})),A=F.reduce((N,U,W)=>(N[U.id]=W,N),{}),j={},k=[],M=t.map(N=>{let U=u[N.name],W=Pt,q=u[N.superClass],T,w=N.interfaces.map($=>u[$]);if(w.length>0){w.sort(Ci);let $=w.join("|");T=j[$],T===void 0&&(T={types:w,offset:-1},j[$]=T)}else T=null;let J=p[N.sourceFileName],G=x.reduce(($,ce,xe)=>{let[Le,Re,Ve,O,ye]=ce;return Le===U&&$.push([xe,Ve,O,Re,ye]),$},[]),K=null,B=G.filter(([,,$])=>$!==null).map(([$,,ce])=>[$,F[A[ce]]]);B.length>0&&(K={methods:B,offset:-1},k.push(K));let Z=C.reduce(($,ce,xe)=>{let[Le]=ce;return Le===U&&$.push([xe>0?1:0,Pt]),$},[]),X=p["<init>"],H=G.filter(([,$])=>$===X).map(([$,,,ce])=>{if(l.has(N.name)){let xe=-1,Le=x.length;for(let Re=0;Re!==Le;Re++){let[Ve,O,ye]=x[Re];if(Ve===q&&ye===X&&O===ce){xe=Re;break}}return[$,Pt|mi,xe]}else return[$,Pt|mi|Rr,-1]}),ae=nf(G.filter(([,$])=>$!==X).map(([$,,,,ce])=>[$,ce|Pt|Rr]));return{index:U,accessFlags:W,superClassIndex:q,interfaces:T,sourceFileIndex:J,annotationsDirectory:K,classData:{instanceFields:Z,constructorMethods:H,virtualMethods:ae,offset:-1}}}),D=Object.keys(j).map(N=>j[N]);return{classes:M,interfaces:D,fields:C,methods:x,protos:y,parameters:S,annotationDirectories:k,annotationSets:F,throwsAnnotations:L,types:h,strings:d}}function nf(t){let e=0;return t.map(([n,r],o)=>{let i;return o===0?i=[n,r]:i=[n-e,r],e=n,i})}function Ci(t,e){return t-e}function rf(t,e){let[,,n,r]=t,[,,o,i]=e;if(n<o)return-1;if(n>o)return 1;let s=r.join("|"),l=i.join("|");return s<l?-1:s>l?1:0}function of(t,e){let[n,r,o]=t,[i,s,l]=e;return n!==i?n-i:o!==l?o-l:r-s}function sf(t,e){let[n,r,o]=t,[i,s,l]=e;return n!==i?n-i:o!==l?o-l:r-s}function af(t){let e=t[0];return e==="L"||e==="["?"L":t}function Te(t){if(t<=127)return[t];let e=[],n=!1;do{let r=t&127;t>>=7,n=t!==0,n&&(r|=128),e.push(r)}while(n);return e}function Pr(t,e){let n=t%e;return n===0?t:t+e-n}function lf(t,e){let n=1,r=0,o=t.length;for(let i=e;i<o;i++)n=(n+t[i])%65521,r=(r+n)%65521;return(r<<16|n)>>>0}var ki=Yu;var cf=1,zr=null,Ii=null;function Ni(t){zr=t}function Dr(t,e,n){let r=pt(t);return r===null&&(t.indexOf("[")===0?r=Ur(t,e,n):(t[0]==="L"&&t[t.length-1]===";"&&(t=t.substring(1,t.length-1)),r=uf(t,e,n))),Object.assign({className:t},r)}var Ti={boolean:{name:"Z",type:"uint8",size:1,byteSize:1,defaultValue:!1,isCompatible(t){return typeof t=="boolean"},fromJni(t){return!!t},toJni(t){return t?1:0},read(t){return t.readU8()},write(t,e){t.writeU8(e)},toString(){return this.name}},byte:{name:"B",type:"int8",size:1,byteSize:1,defaultValue:0,isCompatible(t){return Number.isInteger(t)&&t>=-128&&t<=127},fromJni:Pe,toJni:Pe,read(t){return t.readS8()},write(t,e){t.writeS8(e)},toString(){return this.name}},char:{name:"C",type:"uint16",size:1,byteSize:2,defaultValue:0,isCompatible(t){if(typeof t!="string"||t.length!==1)return!1;let e=t.charCodeAt(0);return e>=0&&e<=65535},fromJni(t){return String.fromCharCode(t)},toJni(t){return t.charCodeAt(0)},read(t){return t.readU16()},write(t,e){t.writeU16(e)},toString(){return this.name}},short:{name:"S",type:"int16",size:1,byteSize:2,defaultValue:0,isCompatible(t){return Number.isInteger(t)&&t>=-32768&&t<=32767},fromJni:Pe,toJni:Pe,read(t){return t.readS16()},write(t,e){t.writeS16(e)},toString(){return this.name}},int:{name:"I",type:"int32",size:1,byteSize:4,defaultValue:0,isCompatible(t){return Number.isInteger(t)&&t>=-2147483648&&t<=2147483647},fromJni:Pe,toJni:Pe,read(t){return t.readS32()},write(t,e){t.writeS32(e)},toString(){return this.name}},long:{name:"J",type:"int64",size:2,byteSize:8,defaultValue:0,isCompatible(t){return typeof t=="number"||t instanceof Int64},fromJni:Pe,toJni:Pe,read(t){return t.readS64()},write(t,e){t.writeS64(e)},toString(){return this.name}},float:{name:"F",type:"float",size:1,byteSize:4,defaultValue:0,isCompatible(t){return typeof t=="number"},fromJni:Pe,toJni:Pe,read(t){return t.readFloat()},write(t,e){t.writeFloat(e)},toString(){return this.name}},double:{name:"D",type:"double",size:2,byteSize:8,defaultValue:0,isCompatible(t){return typeof t=="number"},fromJni:Pe,toJni:Pe,read(t){return t.readDouble()},write(t,e){t.writeDouble(e)},toString(){return this.name}},void:{name:"V",type:"void",size:0,byteSize:0,defaultValue:void 0,isCompatible(t){return t===void 0},fromJni(){},toJni(){return NULL},toString(){return this.name}}},df=new Set(Object.values(Ti).map(t=>t.name));function pt(t){let e=Ti[t];return e!==void 0?e:null}function uf(t,e,n){let r=n._types[e?1:0],o=r[t];return o!==void 0||(t==="java.lang.Object"?o=ff(n):o=pf(t,e,n),r[t]=o),o}function ff(t){return{name:"Ljava/lang/Object;",type:"pointer",size:1,defaultValue:NULL,isCompatible(e){return e===null?!0:e===void 0?!1:e.$h instanceof NativePointer?!0:typeof e=="string"},fromJni(e,n,r){return e.isNull()?null:t.cast(e,t.use("java.lang.Object"),r)},toJni(e,n){return e===null?NULL:typeof e=="string"?n.newStringUtf(e):e.$h}}}function pf(t,e,n){let r=null,o=null,i=null;function s(){return r===null&&(r=n.use(t).class),r}function l(c){let d=s();return o===null&&(o=d.isInstance.overload("java.lang.Object")),o.call(d,c)}function a(){if(i===null){let c=s();i=n.use("java.lang.String").class.isAssignableFrom(c)}return i}return{name:nt(t),type:"pointer",size:1,defaultValue:NULL,isCompatible(c){return c===null?!0:c===void 0?!1:c.$h instanceof NativePointer?l(c):typeof c=="string"&&a()},fromJni(c,d,p){return c.isNull()?null:a()&&e?d.stringFromJni(c):n.cast(c,n.use(t),p)},toJni(c,d){return c===null?NULL:typeof c=="string"?d.newStringUtf(c):c.$h},toString(){return this.name}}}var hf=[["Z","boolean"],["B","byte"],["C","char"],["D","double"],["F","float"],["I","int"],["J","long"],["S","short"]].reduce((t,[e,n])=>(t["["+e]=mf("["+e,n),t),{});function mf(t,e){let n=E.prototype,r=vf(e),o={typeName:e,newArray:n["new"+r+"Array"],setRegion:n["set"+r+"ArrayRegion"],getElements:n["get"+r+"ArrayElements"],releaseElements:n["release"+r+"ArrayElements"]};return{name:t,type:"pointer",size:1,defaultValue:NULL,isCompatible(i){return bf(i,e)},fromJni(i,s,l){return gf(i,o,s,l)},toJni(i,s){return yf(i,o,s)}}}function Ur(t,e,n){let r=hf[t];if(r!==void 0)return r;if(t.indexOf("[")!==0)throw new Error("Unsupported type: "+t);let o=t.substring(1),i=Dr(o,e,n),s=0,l=o.length;for(;s!==l&&o[s]==="[";)s++;o=o.substring(s),o[0]==="L"&&o[o.length-1]===";"&&(o=o.substring(1,o.length-1));let a=o.replace(/\./g,"/");df.has(a)?a="[".repeat(s)+a:a="[".repeat(s)+"L"+a+";";let c="["+a;return o="[".repeat(s)+o,{name:t.replace(/\./g,"/"),type:"pointer",size:1,defaultValue:NULL,isCompatible(d){return d===null?!0:typeof d!="object"||d.length===void 0?!1:d.every(function(p){return i.isCompatible(p)})},fromJni(d,p,h){if(d.isNull())return null;let u=[],g=p.getArrayLength(d);for(let _=0;_!==g;_++){let y=p.getObjectArrayElement(d,_);try{u.push(i.fromJni(y,p))}finally{p.deleteLocalRef(y)}}try{u.$w=n.cast(d,n.use(c),h)}catch{n.use("java.lang.reflect.Array").newInstance(n.use(o).class,0),u.$w=n.cast(d,n.use(c),h)}return u.$dispose=_f,u},toJni(d,p){if(d===null)return NULL;if(!(d instanceof Array))throw new Error("Expected an array");let h=d.$w;if(h!==void 0)return h.$h;let u=d.length,_=n.use(o).$borrowClassHandle(p);try{let y=p.newObjectArray(u,_.value,NULL);p.throwIfExceptionPending();for(let v=0;v!==u;v++){let S=i.toJni(d[v],p);try{p.setObjectArrayElement(y,v,S)}finally{i.type==="pointer"&&p.getObjectRefType(S)===cf&&p.deleteLocalRef(S)}p.throwIfExceptionPending()}return y}finally{_.unref(p)}}}}function _f(){let t=this.length;for(let e=0;e!==t;e++){let n=this[e];if(n===null)continue;let r=n.$dispose;if(r===void 0)break;r.call(n)}this.$w.$dispose()}function gf(t,e,n,r){if(t.isNull())return null;let o=pt(e.typeName),i=n.getArrayLength(t);return new dn(t,e,o,i,n,r)}function yf(t,e,n){if(t===null)return NULL;let r=t.$h;if(r!==void 0)return r;let o=t.length,i=pt(e.typeName),s=e.newArray.call(n,o);if(s.isNull())throw new Error("Unable to construct array");if(o>0){let l=i.byteSize,a=i.write,c=i.toJni,d=Memory.alloc(o*i.byteSize);for(let p=0;p!==o;p++)a(d.add(p*l),c(t[p]));e.setRegion.call(n,s,0,o,d),n.throwIfExceptionPending()}return s}function bf(t,e){if(t===null)return!0;if(t instanceof dn)return t.$s.typeName===e;if(!(typeof t=="object"&&t.length!==void 0))return!1;let r=pt(e);return Array.prototype.every.call(t,o=>r.isCompatible(o))}function dn(t,e,n,r,o,i=!0){if(i){let s=o.newGlobalRef(t);this.$h=s,this.$r=Script.bindWeak(this,o.vm.makeHandleDestructor(s))}else this.$h=t,this.$r=null;return this.$s=e,this.$t=n,this.length=r,new Proxy(this,Ii)}Ii={has(t,e){return e in t?!0:t.tryParseIndex(e)!==null},get(t,e,n){let r=t.tryParseIndex(e);return r===null?t[e]:t.readElement(r)},set(t,e,n,r){let o=t.tryParseIndex(e);return o===null?(t[e]=n,!0):(t.writeElement(o,n),!0)},ownKeys(t){let e=[],{length:n}=t;for(let r=0;r!==n;r++){let o=r.toString();e.push(o)}return e.push("length"),e},getOwnPropertyDescriptor(t,e){return t.tryParseIndex(e)!==null?{writable:!0,configurable:!0,enumerable:!0}:Object.getOwnPropertyDescriptor(t,e)}};Object.defineProperties(dn.prototype,{$dispose:{enumerable:!0,value(){let t=this.$r;t!==null&&(this.$r=null,Script.unbindWeak(t))}},$clone:{value(t){return new dn(this.$h,this.$s,this.$t,this.length,t)}},tryParseIndex:{value(t){if(typeof t=="symbol")return null;let e=parseInt(t);return isNaN(e)||e<0||e>=this.length?null:e}},readElement:{value(t){return this.withElements(e=>{let n=this.$t;return n.fromJni(n.read(e.add(t*n.byteSize)))})}},writeElement:{value(t,e){let{$h:n,$s:r,$t:o}=this,i=zr.getEnv(),s=Memory.alloc(o.byteSize);o.write(s,o.toJni(e)),r.setRegion.call(i,n,t,1,s)}},withElements:{value(t){let{$h:e,$s:n}=this,r=zr.getEnv(),o=n.getElements.call(r,e);if(o.isNull())throw new Error("Unable to get array elements");try{return t(o)}finally{n.releaseElements.call(r,e,o)}}},toJSON:{value(){let{length:t,$t:e}=this,{byteSize:n,fromJni:r,read:o}=e;return this.withElements(i=>{let s=[];for(let l=0;l!==t;l++){let a=r(o(i.add(l*n)));s.push(a)}return s})}},toString:{value(){return this.toJSON().toString()}}});function nt(t){return"L"+t.replace(/\./g,"/")+";"}function vf(t){return t.charAt(0).toUpperCase()+t.slice(1)}function Pe(t){return t}var Sf=4,{ensureClassInitialized:xi,makeMethodMangler:Pi}=ln,Ef=8,Jr=1,Ft=2,$e=3,Br=1,Gr=2,un=1,Ri=2,Li=Symbol("PENDING_USE"),Mi="/data/local/tmp",{getCurrentThreadId:pn,pointerSize:Rt}=Process,Se={state:"empty",factories:[],loaders:null,Integer:null},re=null,ue=null,Fi=null,zi=null,Di=null,Ui=null,Bi=null,Ai=null,Vr=null,mt=new Map,Ke=class t{static _initialize(e,n){re=e,ue=n,Fi=n.flavor==="art",n.flavor==="jvm"&&(xi=li,Pi=di)}static _disposeAll(e){Se.factories.forEach(n=>{n._dispose(e)})}static get(e){let n=Vf(),r=n.factories[0];if(e===null)return r;let o=n.loaders.get(e);if(o!==null){let s=r.cast(o,n.Integer);return n.factories[s.intValue()]}let i=new t;return i.loader=e,i.cacheDir=r.cacheDir,Zr(i,e),i}constructor(){this.cacheDir=Mi,this.codeCacheDir=Mi+"/dalvik-cache",this.tempFileNaming={prefix:"frida",suffix:""},this._classes={},this._classHandles=new jt(10,Cf),this._patchedMethods=new Set,this._loader=null,this._types=[{},{}],Se.factories.push(this)}_dispose(e){Array.from(this._patchedMethods).forEach(n=>{n.implementation=null}),this._patchedMethods.clear(),Cr(),this._classHandles.dispose(e),this._classes={}}get loader(){return this._loader}set loader(e){let n=this._loader===null&&e!==null;this._loader=e,n&&Se.state==="ready"&&this===Se.factories[0]&&Zr(this,e)}use(e,n={}){let r=n.cache!=="skip",o=r?this._getUsedClass(e):void 0;if(o===void 0)try{let i=re.getEnv(),{_loader:s}=this,l=s!==null?If(e,s,i):kf(e);o=this._make(e,l,i)}finally{r&&this._setUsedClass(e,o)}return o}_getUsedClass(e){let n;for(;(n=this._classes[e])===Li;)Thread.sleep(.05);return n===void 0&&(this._classes[e]=Li),n}_setUsedClass(e,n){n!==void 0?this._classes[e]=n:delete this._classes[e]}_make(e,n,r){let o=wf(),i=Object.create(qr.prototype,{[Symbol.for("n")]:{value:e},$n:{get(){return this[Symbol.for("n")]}},[Symbol.for("C")]:{value:o},$C:{get(){return this[Symbol.for("C")]}},[Symbol.for("w")]:{value:null,writable:!0},$w:{get(){return this[Symbol.for("w")]},set(a){this[Symbol.for("w")]=a}},[Symbol.for("_s")]:{writable:!0},$_s:{get(){return this[Symbol.for("_s")]},set(a){this[Symbol.for("_s")]=a}},[Symbol.for("c")]:{value:[null]},$c:{get(){return this[Symbol.for("c")]}},[Symbol.for("m")]:{value:new Map},$m:{get(){return this[Symbol.for("m")]}},[Symbol.for("l")]:{value:null,writable:!0},$l:{get(){return this[Symbol.for("l")]},set(a){this[Symbol.for("l")]=a}},[Symbol.for("gch")]:{value:n},$gch:{get(){return this[Symbol.for("gch")]}},[Symbol.for("f")]:{value:this},$f:{get(){return this[Symbol.for("f")]}}});o.prototype=i;let s=new o(null);i[Symbol.for("w")]=s,i.$w=s;let l=s.$borrowClassHandle(r);try{let a=l.value;xi(r,a),i.$l=tt.build(a,r)}finally{l.unref(r)}return s}retain(e){let n=re.getEnv();return e.$clone(n)}cast(e,n,r){let o=re.getEnv(),i=e.$h;i===void 0&&(i=e);let s=n.$borrowClassHandle(o);try{if(!o.isInstanceOf(i,s.value))throw new Error(`Cast from '${o.getObjectClassName(i)}' to '${n.$n}' isn't possible`)}finally{s.unref(o)}let l=n.$C;return new l(i,un,o,r)}wrap(e,n,r){let o=n.$C,i=new o(e,un,r,!1);return i.$r=Script.bindWeak(i,re.makeHandleDestructor(e)),i}array(e,n){let r=re.getEnv(),o=pt(e);o!==null&&(e=o.name);let i=Ur("["+e,!1,this),s=i.toJni(n,r);return i.fromJni(s,r,!0)}registerClass(e){let n=re.getEnv(),r=[];try{let o=this.use("java.lang.Class"),i=n.javaLangReflectMethod(),s=n.vaMethod("pointer",[]),l=e.name,a=e.implements||[],c=e.superClass||this.use("java.lang.Object"),d=[],p=[],h={name:nt(l),sourceFileName:Gf(l),superClass:nt(c.$n),interfaces:a.map(k=>nt(k.$n)),fields:d,methods:p},u=a.slice();a.forEach(k=>{Array.prototype.slice.call(k.class.getInterfaces()).forEach(M=>{let D=this.cast(M,o).getCanonicalName();u.push(this.use(D))})});let g=e.fields||{};Object.getOwnPropertyNames(g).forEach(k=>{let M=this._getType(g[k]);d.push([k,M.name])});let _={},y={};u.forEach(k=>{let M=k.$borrowClassHandle(n);r.push(M);let D=M.value;k.$ownMembers.filter(N=>k[N].overloads!==void 0).forEach(N=>{let U=k[N],W=U.overloads,q=W.map(T=>Oi(N,T.returnType,T.argumentTypes));_[N]=[U,q,D],W.forEach((T,w)=>{let J=q[w];y[J]=[T,D]})})});let v=e.methods||{},C=Object.keys(v).reduce((k,M)=>{let D=v[M],N=M==="$init"?"<init>":M;return D instanceof Array?k.push(...D.map(U=>[N,U])):k.push([N,D]),k},[]),x=[];C.forEach(([k,M])=>{let D=$e,N,U,W=[],q;if(typeof M=="function"){let G=_[k];if(G!==void 0&&Array.isArray(G)){let[K,B,Z]=G;if(B.length>1)throw new Error(`More than one overload matching '${k}': signature must be specified`);delete y[B[0]];let X=K.overloads[0];D=X.type,N=X.returnType,U=X.argumentTypes,q=M;let H=n.toReflectedMethod(Z,X.handle,0),ae=s(n.handle,H,i.getGenericExceptionTypes);W=Wr(n,ae).map(nt),n.deleteLocalRef(ae),n.deleteLocalRef(H)}else N=this._getType("void"),U=[],q=M}else{if(M.isStatic&&(D=Ft),N=this._getType(M.returnType||"void"),U=(M.argumentTypes||[]).map(B=>this._getType(B)),q=M.implementation,typeof q!="function")throw new Error("Expected a function implementation for method: "+k);let G=Oi(k,N,U),K=y[G];if(K!==void 0){let[B,Z]=K;delete y[G],D=B.type,N=B.returnType,U=B.argumentTypes;let X=n.toReflectedMethod(Z,B.handle,0),H=s(n.handle,X,i.getGenericExceptionTypes);W=Wr(n,H).map(nt),n.deleteLocalRef(H),n.deleteLocalRef(X)}}let T=N.name,w=U.map(G=>G.name),J="("+w.join("")+")"+T;p.push([k,T,w,W,D===Ft?Ef:0]),x.push([k,J,D,N,U,q])});let L=Object.keys(y);if(L.length>0)throw new Error("Missing implementation for: "+L.join(", "));let F=fn.fromBuffer(ki(h),this);try{F.load()}finally{F.file.delete()}let A=this.use(e.name),j=C.length;if(j>0){let k=3*Rt,M=Memory.alloc(j*k),D=[],N=[];x.forEach(([q,T,w,J,G,K],B)=>{let Z=Memory.allocUtf8String(q),X=Memory.allocUtf8String(T),H=Vi(q,A,w,J,G,K);M.add(B*k).writePointer(Z),M.add(B*k+Rt).writePointer(X),M.add(B*k+2*Rt).writePointer(H),N.push(Z,X),D.push(H)});let U=A.$borrowClassHandle(n);r.push(U);let W=U.value;n.registerNatives(W,M,j),n.throwIfExceptionPending(),A.$nativeMethods=D}return A}finally{r.forEach(o=>{o.unref(n)})}}choose(e,n){let r=re.getEnv(),{flavor:o}=ue;if(o==="jvm")this._chooseObjectsJvm(e,r,n);else if(o==="art"){let i=ue["art::gc::Heap::VisitObjects"]===void 0;if(i&&ue["art::gc::Heap::GetInstances"]===void 0)return this._chooseObjectsJvm(e,r,n);Oe(re,r,s=>{i?this._chooseObjectsArtPreA12(e,r,s,n):this._chooseObjectsArtLegacy(e,r,s,n)})}else this._chooseObjectsDalvik(e,r,n)}_chooseObjectsJvm(e,n,r){let o=this.use(e),{jvmti:i}=ue,s=1,l=3,a=o.$borrowClassHandle(n),c=int64(a.value.toString());try{let d=new NativeCallback((v,S,C,x)=>(C.writeS64(c),s),"int",["int64","int64","pointer","pointer"]);i.iterateOverInstancesOfClass(a.value,l,d,a.value);let p=Memory.alloc(8);p.writeS64(c);let h=Memory.alloc(Sf),u=Memory.alloc(Rt);i.getObjectsWithTags(1,p,h,u,NULL);let g=h.readS32(),_=u.readPointer(),y=[];for(let v=0;v!==g;v++)y.push(_.add(v*Rt).readPointer());i.deallocate(_);try{for(let v of y){let S=this.cast(v,o);if(r.onMatch(S)==="stop")break}r.onComplete()}finally{y.forEach(v=>{n.deleteLocalRef(v)})}}finally{a.unref(n)}}_chooseObjectsArtPreA12(e,n,r,o){let i=this.use(e),s=Lt.$new(r,re),l,a=i.$borrowClassHandle(n);try{let h=ue["art::JavaVMExt::DecodeGlobal"](ue.vm,r,a.value);l=s.newHandle(h)}finally{a.unref(n)}let c=0,d=xt.$new();ue["art::gc::Heap::GetInstances"](ue.artHeap,s,l,c,d);let p=d.handles.map(h=>n.newGlobalRef(h));d.$delete(),s.$delete();try{for(let h of p){let u=this.cast(h,i);if(o.onMatch(u)==="stop")break}o.onComplete()}finally{p.forEach(h=>{n.deleteGlobalRef(h)})}}_chooseObjectsArtLegacy(e,n,r,o){let i=this.use(e),s=[],l=ue["art::JavaVMExt::AddGlobalRef"],a=ue.vm,c,d=i.$borrowClassHandle(n);try{c=ue["art::JavaVMExt::DecodeGlobal"](a,r,d.value).toInt32()}finally{d.unref(n)}let p=Lr(c,h=>{s.push(l(a,r,h))});ue["art::gc::Heap::VisitObjects"](ue.artHeap,p,NULL);try{for(let h of s){let u=this.cast(h,i);if(o.onMatch(u)==="stop")break}}finally{s.forEach(h=>{n.deleteGlobalRef(h)})}o.onComplete()}_chooseObjectsDalvik(e,n,r){let o=this.use(e);if(ue.addLocalReference===null){let s=Process.getModuleByName("libdvm.so"),l;switch(Process.arch){case"arm":l="2d e9 f0 41 05 46 15 4e 0c 46 7e 44 11 b3 43 68";break;case"ia32":l="8d 64 24 d4 89 5c 24 1c 89 74 24 20 e8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 85 d2";break}Memory.scan(s.base,s.size,l,{onMatch:(a,c)=>{let d;if(Process.arch==="arm")a=a.or(1),d=new NativeFunction(a,"pointer",["pointer","pointer"]);else{let p=Memory.alloc(Process.pageSize);Memory.patchCode(p,16,h=>{let u=new X86Writer(h,{pc:p});u.putMovRegRegOffsetPtr("eax","esp",4),u.putMovRegRegOffsetPtr("edx","esp",8),u.putJmpAddress(a),u.flush()}),d=new NativeFunction(p,"pointer",["pointer","pointer"]),d._thunk=p}return ue.addLocalReference=d,re.perform(p=>{i(this,p)}),"stop"},onError(a){},onComplete(){ue.addLocalReference===null&&r.onComplete()}})}else i(this,n);function i(s,l){let{DVM_JNI_ENV_OFFSET_SELF:a}=ln,c=l.handle.add(a).readPointer(),d,p=o.$borrowClassHandle(l);try{d=ue.dvmDecodeIndirectRef(c,p.value)}finally{p.unref(l)}let h=d.toMatchPattern(),u=ue.dvmHeapSourceGetBase(),_=ue.dvmHeapSourceGetLimit().sub(u).toInt32();Memory.scan(u,_,h,{onMatch:(y,v)=>{ue.dvmIsValidObject(y)&&re.perform(S=>{let C=S.handle.add(a).readPointer(),x,L=ue.addLocalReference(C,y);try{x=s.cast(L,o)}finally{S.deleteLocalRef(L)}if(r.onMatch(x)==="stop")return"stop"})},onError(y){},onComplete(){r.onComplete()}})}}openClassFile(e){return new fn(e,null,this)}_getType(e,n=!0){return Dr(e,n,this)}};function wf(){return function(t,e,n,r){return qr.call(this,t,e,n,r)}}function qr(t,e,n,r=!0){if(t!==null)if(r){let o=n.newGlobalRef(t);this.$h=o,this.$r=Script.bindWeak(this,re.makeHandleDestructor(o))}else this.$h=t,this.$r=null;else this.$h=null,this.$r=null;return this.$t=e,new Proxy(this,zi)}zi={has(t,e){return e in t?!0:t.$has(e)},get(t,e,n){if(typeof e!="string"||e.startsWith("$")||e==="class")return t[e];let r=t.$find(e);return r!==null?r(n):t[e]},set(t,e,n,r){return t[e]=n,!0},ownKeys(t){return t.$list()},getOwnPropertyDescriptor(t,e){return Object.prototype.hasOwnProperty.call(t,e)?Object.getOwnPropertyDescriptor(t,e):{writable:!1,configurable:!0,enumerable:!0}}};Object.defineProperties(qr.prototype,{[Symbol.for("new")]:{enumerable:!1,get(){return this.$getCtor("allocAndInit")}},$new:{enumerable:!0,get(){return this[Symbol.for("new")]}},[Symbol.for("alloc")]:{enumerable:!1,value(){let t=re.getEnv(),e=this.$borrowClassHandle(t);try{let n=t.allocObject(e.value);return this.$f.cast(n,this)}finally{e.unref(t)}}},$alloc:{enumerable:!0,get(){return this[Symbol.for("alloc")]}},[Symbol.for("init")]:{enumerable:!1,get(){return this.$getCtor("initOnly")}},$init:{enumerable:!0,get(){return this[Symbol.for("init")]}},[Symbol.for("dispose")]:{enumerable:!1,value(){let t=this.$r;t!==null&&(this.$r=null,Script.unbindWeak(t)),this.$h!==null&&(this.$h=void 0)}},$dispose:{enumerable:!0,get(){return this[Symbol.for("dispose")]}},[Symbol.for("clone")]:{enumerable:!1,value(t){let e=this.$C;return new e(this.$h,this.$t,t)}},$clone:{value(t){return this[Symbol.for("clone")](t)}},[Symbol.for("class")]:{enumerable:!1,get(){let t=re.getEnv(),e=this.$borrowClassHandle(t);try{let n=this.$f;return n.cast(e.value,n.use("java.lang.Class"))}finally{e.unref(t)}}},class:{enumerable:!0,get(){return this[Symbol.for("class")]}},[Symbol.for("className")]:{enumerable:!1,get(){let t=this.$h;return t===null?this.$n:re.getEnv().getObjectClassName(t)}},$className:{enumerable:!0,get(){return this[Symbol.for("className")]}},[Symbol.for("ownMembers")]:{enumerable:!1,get(){return this.$l.list()}},$ownMembers:{enumerable:!0,get(){return this[Symbol.for("ownMembers")]}},[Symbol.for("super")]:{enumerable:!1,get(){let t=re.getEnv(),e=this.$s.$C;return new e(this.$h,Ri,t)}},$super:{enumerable:!0,get(){return this[Symbol.for("super")]}},[Symbol.for("s")]:{enumerable:!1,get(){let t=Object.getPrototypeOf(this),e=t.$_s;if(e===void 0){let n=re.getEnv(),r=this.$borrowClassHandle(n);try{let o=n.getSuperclass(r.value);if(o.isNull())e=null;else try{let i=n.getClassName(o),s=t.$f;if(e=s._getUsedClass(i),e===void 0)try{let l=Nf(this);e=s._make(i,l,n)}finally{s._setUsedClass(i,e)}}finally{n.deleteLocalRef(o)}}finally{r.unref(n)}t.$_s=e}return e}},$s:{get(){return this[Symbol.for("s")]}},[Symbol.for("isSameObject")]:{enumerable:!1,value(t){return re.getEnv().isSameObject(t.$h,this.$h)}},$isSameObject:{value(t){return this[Symbol.for("isSameObject")](t)}},[Symbol.for("getCtor")]:{enumerable:!1,value(t){let e=this.$c,n=e[0];if(n===null){let r=re.getEnv(),o=this.$borrowClassHandle(r);try{n=Tf(o.value,this.$w,r),e[0]=n}finally{o.unref(r)}}return n[t]}},$getCtor:{value(t){return this[Symbol.for("getCtor")](t)}},[Symbol.for("borrowClassHandle")]:{enumerable:!1,value(t){let e=this.$n,n=this.$f._classHandles,r=n.get(e);return r===void 0&&(r=new Kr(this.$gch(t),t),n.set(e,r,t)),r.ref()}},$borrowClassHandle:{value(t){return this[Symbol.for("borrowClassHandle")](t)}},[Symbol.for("copyClassHandle")]:{enumerable:!1,value(t){let e=this.$borrowClassHandle(t);try{return t.newLocalRef(e.value)}finally{e.unref(t)}}},$copyClassHandle:{value(t){return this[Symbol.for("copyClassHandle")](t)}},[Symbol.for("getHandle")]:{enumerable:!1,value(t){let e=this.$h;if(e===void 0)throw new Error("Wrapper is disposed; perhaps it was borrowed from a hook instead of calling Java.retain() to make a long-lived wrapper?");return e}},$getHandle:{value(t){return this[Symbol.for("getHandle")](t)}},[Symbol.for("list")]:{enumerable:!1,value(){let t=this.$s,e=t!==null?t.$list():[],n=this.$l;return Array.from(new Set(e.concat(n.list())))}},$list:{get(){return this[Symbol.for("list")]}},[Symbol.for("has")]:{enumerable:!1,value(t){if(this.$m.has(t)||this.$l.has(t))return!0;let r=this.$s;return!!(r!==null&&r.$has(t))}},$has:{value(t){return this[Symbol.for("has")](t)}},[Symbol.for("find")]:{enumerable:!1,value(t){let e=this.$m,n=e.get(t);if(n!==void 0)return n;let o=this.$l.find(t);if(o!==null){let s=re.getEnv(),l=this.$borrowClassHandle(s);try{n=xf(t,o,l.value,this.$w,s)}finally{l.unref(s)}return e.set(t,n),n}let i=this.$s;return i!==null?i.$find(t):null}},$find:{value(t){return this[Symbol.for("find")](t)}},[Symbol.for("toJSON")]:{enumerable:!1,value(){let t=this.$n;if(this.$h===null)return`<class: ${t}>`;let n=this.$className;return t===n?`<instance: ${t}>`:`<instance: ${t}, $className: ${n}>`}},toJSON:{get(){return this[Symbol.for("toJSON")]}}});function Kr(t,e){this.value=e.newGlobalRef(t),e.deleteLocalRef(t),this.refs=1}Kr.prototype.ref=function(){return this.refs++,this};Kr.prototype.unref=function(t){--this.refs===0&&t.deleteGlobalRef(this.value)};function Cf(t,e){t.unref(e)}function kf(t){let e=t.replace(/\./g,"/");return function(n){let r=pn();Gi(r);try{return n.findClass(e)}finally{Hi(r)}}}function If(t,e,n){return Vr===null&&(Ai=n.vaMethod("pointer",["pointer"]),Vr=e.loadClass.overload("java.lang.String").handle),n=null,function(r){let o=r.newStringUtf(t),i=pn();Gi(i);try{let s=Ai(r.handle,e.$h,Vr,o);return r.throwIfExceptionPending(),s}finally{Hi(i),r.deleteLocalRef(o)}}}function Nf(t){return function(e){let n=t.$borrowClassHandle(e);try{return e.getSuperclass(n.value)}finally{n.unref(e)}}}function Tf(t,e,n){let{$n:r,$f:o}=e,i=Jf(r),s=n.javaLangClass(),l=n.javaLangReflectConstructor(),a=n.vaMethod("pointer",[]),c=n.vaMethod("uint8",[]),d=[],p=[],h=o._getType(r,!1),u=o._getType("void",!1),g=a(n.handle,t,s.getDeclaredConstructors);try{let _=n.getArrayLength(g);if(_!==0)for(let y=0;y!==_;y++){let v,S,C=n.getObjectArrayElement(g,y);try{v=n.fromReflectedMethod(C),S=a(n.handle,C,l.getGenericParameterTypes)}finally{n.deleteLocalRef(C)}let x;try{x=Wr(n,S).map(L=>o._getType(L))}finally{n.deleteLocalRef(S)}d.push(ht(i,e,Jr,v,h,x,n)),p.push(ht(i,e,$e,v,u,x,n))}else{if(c(n.handle,t,s.isInterface))throw new Error("cannot instantiate an interface");let v=n.javaLangObject(),S=n.getMethodId(v,"<init>","()V");d.push(ht(i,e,Jr,S,h,[],n)),p.push(ht(i,e,$e,S,u,[],n))}}finally{n.deleteLocalRef(g)}if(p.length===0)throw new Error("no supported overloads");return{allocAndInit:Hr(d),initOnly:Hr(p)}}function xf(t,e,n,r,o){return e.startsWith("m")?Lf(t,e,n,r,o):Df(t,e,n,r,o)}function Lf(t,e,n,r,o){let{$f:i}=r,s=e.split(":").slice(1),l=o.javaLangReflectMethod(),a=o.vaMethod("pointer",[]),c=o.vaMethod("uint8",[]),d=s.map(h=>{let u=h[0]==="s"?Ft:$e,g=ptr(h.substr(1)),_,y=[],v=o.toReflectedMethod(n,g,u===Ft?1:0);try{let S=!!c(o.handle,v,l.isVarArgs),C=a(o.handle,v,l.getGenericReturnType);o.throwIfExceptionPending();try{_=i._getType(o.getTypeName(C))}finally{o.deleteLocalRef(C)}let x=a(o.handle,v,l.getParameterTypes);try{let L=o.getArrayLength(x);for(let F=0;F!==L;F++){let A=o.getObjectArrayElement(x,F),j;try{j=S&&F===L-1?o.getArrayTypeName(A):o.getTypeName(A)}finally{o.deleteLocalRef(A)}let k=i._getType(j);y.push(k)}}finally{o.deleteLocalRef(x)}}catch{return null}finally{o.deleteLocalRef(v)}return ht(t,r,u,g,_,y,o)}).filter(h=>h!==null);if(d.length===0)throw new Error("No supported overloads");t==="valueOf"&&Rf(d);let p=Hr(d);return function(h){return p}}function Hr(t){let e=Mf();return Object.setPrototypeOf(e,Di),e._o=t,e}function Mf(){let t=function(){return t.invoke(this,arguments)};return t}Di=Object.create(Function.prototype,{overloads:{enumerable:!0,get(){return this._o}},overload:{value(...t){let e=this._o,n=t.length,r=t.join(":");for(let o=0;o!==e.length;o++){let i=e[o],{argumentTypes:s}=i;if(s.length!==n)continue;if(s.map(a=>a.className).join(":")===r)return i}$r(this.methodName,this.overloads,"specified argument types do not match any of:")}},methodName:{enumerable:!0,get(){return this._o[0].methodName}},holder:{enumerable:!0,get(){return this._o[0].holder}},type:{enumerable:!0,get(){return this._o[0].type}},handle:{enumerable:!0,get(){return rt(this),this._o[0].handle}},implementation:{enumerable:!0,get(){return rt(this),this._o[0].implementation},set(t){rt(this),this._o[0].implementation=t}},returnType:{enumerable:!0,get(){return rt(this),this._o[0].returnType}},argumentTypes:{enumerable:!0,get(){return rt(this),this._o[0].argumentTypes}},canInvokeWith:{enumerable:!0,get(t){return rt(this),this._o[0].canInvokeWith}},clone:{enumerable:!0,value(t){return rt(this),this._o[0].clone(t)}},invoke:{value(t,e){let n=this._o,r=t.$h!==null;for(let o=0;o!==n.length;o++){let i=n[o];if(i.canInvokeWith(e)){if(i.type===$e&&!r){let s=this.methodName;if(s==="toString")return`<class: ${t.$n}>`;throw new Error(s+": cannot call instance method without an instance")}return i.apply(t,e)}}if(this.methodName==="toString")return`<class: ${t.$n}>`;$r(this.methodName,this.overloads,"argument types do not match any of:")}}});function Oi(t,e,n){return`${e.className} ${t}(${n.map(r=>r.className).join(", ")})`}function rt(t){let e=t._o;e.length>1&&$r(e[0].methodName,e,"has more than one overload, use .overload(<signature>) to choose from:")}function $r(t,e,n){let o=e.slice().sort((i,s)=>i.argumentTypes.length-s.argumentTypes.length).map(i=>i.argumentTypes.length>0?".overload('"+i.argumentTypes.map(l=>l.className).join("', '")+"')":".overload()");throw new Error(`${t}(): ${n}
	${o.join(`
	`)}`)}function ht(t,e,n,r,o,i,s,l){let a=o.type,c=i.map(h=>h.type);s===null&&(s=re.getEnv());let d,p;return n===$e?(d=s.vaMethod(a,c,l),p=s.nonvirtualVaMethod(a,c,l)):n===Ft?(d=s.staticVaMethod(a,c,l),p=d):(d=s.constructor(c,l),p=d),Af([t,e,n,r,o,i,d,p])}function Af(t){let e=Of();return Object.setPrototypeOf(e,Ui),e._p=t,e}function Of(){let t=function(){return t.invoke(this,arguments)};return t}Ui=Object.create(Function.prototype,{methodName:{enumerable:!0,get(){return this._p[0]}},holder:{enumerable:!0,get(){return this._p[1]}},type:{enumerable:!0,get(){return this._p[2]}},handle:{enumerable:!0,get(){return this._p[3]}},implementation:{enumerable:!0,get(){let t=this._r;return t!==void 0?t:null},set(t){let e=this._p,n=e[1];if(e[2]===Jr)throw new Error("Reimplementing $new is not possible; replace implementation of $init instead");let o=this._r;if(o!==void 0&&(n.$f._patchedMethods.delete(this),o._m.revert(re),this._r=void 0),t!==null){let[i,s,l,a,c,d]=e,p=Vi(i,s,l,c,d,t,this),h=Pi(a);p._m=h,this._r=p,h.replace(p,l===$e,d,re,ue),n.$f._patchedMethods.add(this)}}},returnType:{enumerable:!0,get(){return this._p[4]}},argumentTypes:{enumerable:!0,get(){return this._p[5]}},canInvokeWith:{enumerable:!0,value(t){let e=this._p[5];return t.length!==e.length?!1:e.every((n,r)=>n.isCompatible(t[r]))}},clone:{enumerable:!0,value(t){let e=this._p.slice(0,6);return ht(...e,null,t)}},invoke:{value(t,e){let n=re.getEnv(),r=this._p,o=r[2],i=r[4],s=r[5],l=this._r,a=o===$e,c=e.length,d=2+c;n.pushLocalFrame(d);let p=null;try{let h;a?h=t.$getHandle():(p=t.$borrowClassHandle(n),h=p.value);let u,g=t.$t;l===void 0?u=r[3]:(u=l._m.resolveTarget(t,a,n,ue),Fi&&l._c.has(pn())&&(g=Ri));let _=[n.handle,h,u];for(let S=0;S!==c;S++)_.push(s[S].toJni(e[S],n));let y;g===un?y=r[6]:(y=r[7],a&&_.splice(2,0,t.$copyClassHandle(n)));let v=y.apply(null,_);return n.throwIfExceptionPending(),i.fromJni(v,n,!0)}finally{p!==null&&p.unref(n),n.popLocalFrame(NULL)}}},toString:{enumerable:!0,value(){return`function ${this.methodName}(${this.argumentTypes.map(t=>t.className).join(", ")}): ${this.returnType.className}`}}});function Vi(t,e,n,r,o,i,s=null){let l=new Set,a=jf([t,e,n,r,o,i,s,l]),c=new NativeCallback(a,r.type,["pointer","pointer"].concat(o.map(d=>d.type)));return c._c=l,c}function jf(t){return function(){return Pf(arguments,t)}}function Pf(t,e){let n=new E(t[0],re),[r,o,i,s,l,a,c,d]=e,p=[],h;if(i===$e){let _=o.$C;h=new _(t[1],un,n,!1)}else h=o;let u=pn();n.pushLocalFrame(3);let g=!0;re.link(u,n);try{d.add(u);let _;c===null||!mt.has(u)?_=a:_=c;let y=[],v=t.length-2;for(let x=0;x!==v;x++){let F=l[x].fromJni(t[2+x],n,!1);y.push(F),p.push(F)}let S=_.apply(h,y);if(!s.isCompatible(S))throw new Error(`Implementation for ${r} expected return value compatible with ${s.className}`);let C=s.toJni(S,n);return s.type==="pointer"&&(C=n.popLocalFrame(C),g=!1,p.push(S)),C}catch(_){let y=_.$h;return y!==void 0?n.throw(y):Script.nextTick(()=>{throw _}),s.defaultValue}finally{re.unlink(u),g&&n.popLocalFrame(NULL),d.delete(u),p.forEach(_=>{if(_===null)return;let y=_.$dispose;y!==void 0&&y.call(_)})}}function Rf(t){let{holder:e,type:n}=t[0];t.some(o=>o.type===n&&o.argumentTypes.length===0)||t.push(Ff([e,n]))}function Ff(t){let e=zf();return Object.setPrototypeOf(e,Bi),e._p=t,e}function zf(){return function(){return this}}Bi=Object.create(Function.prototype,{methodName:{enumerable:!0,get(){return"valueOf"}},holder:{enumerable:!0,get(){return this._p[0]}},type:{enumerable:!0,get(){return this._p[1]}},handle:{enumerable:!0,get(){return NULL}},implementation:{enumerable:!0,get(){return null},set(t){}},returnType:{enumerable:!0,get(){let t=this.holder;return t.$f.use(t.$n)}},argumentTypes:{enumerable:!0,get(){return[]}},canInvokeWith:{enumerable:!0,value(t){return t.length===0}},clone:{enumerable:!0,value(t){throw new Error("Invalid operation")}}});function Df(t,e,n,r,o){let i=e[2]==="s"?Br:Gr,s=ptr(e.substr(3)),{$f:l}=r,a,c=o.toReflectedField(n,s,i===Br?1:0);try{a=o.vaMethod("pointer",[])(o.handle,c,o.javaLangReflectField().getGenericType),o.throwIfExceptionPending()}finally{o.deleteLocalRef(c)}let d;try{d=l._getType(o.getTypeName(a))}finally{o.deleteLocalRef(a)}let p,h,u=d.type;return i===Br?(p=o.getStaticField(u),h=o.setStaticField(u)):(p=o.getField(u),h=o.setField(u)),Uf([i,d,s,p,h])}function Uf(t){return function(e){return new Ji([e].concat(t))}}function Ji(t){this._p=t}Object.defineProperties(Ji.prototype,{value:{enumerable:!0,get(){let[t,e,n,r,o]=this._p,i=re.getEnv();i.pushLocalFrame(4);let s=null;try{let l;if(e===Gr){if(l=t.$getHandle(),l===null)throw new Error("Cannot access an instance field without an instance")}else s=t.$borrowClassHandle(i),l=s.value;let a=o(i.handle,l,r);return i.throwIfExceptionPending(),n.fromJni(a,i,!0)}finally{s!==null&&s.unref(i),i.popLocalFrame(NULL)}},set(t){let[e,n,r,o,,i]=this._p,s=re.getEnv();s.pushLocalFrame(4);let l=null;try{let a;if(n===Gr){if(a=e.$getHandle(),a===null)throw new Error("Cannot access an instance field without an instance")}else l=e.$borrowClassHandle(s),a=l.value;if(!r.isCompatible(t))throw new Error(`Expected value compatible with ${r.className}`);let c=r.toJni(t,s);i(s.handle,a,o,c),s.throwIfExceptionPending()}finally{l!==null&&l.unref(s),s.popLocalFrame(NULL)}}},holder:{enumerable:!0,get(){return this._p[0]}},fieldType:{enumerable:!0,get(){return this._p[1]}},fieldReturnType:{enumerable:!0,get(){return this._p[2]}},toString:{enumerable:!0,value(){let t=`Java.Field{holder: ${this.holder}, fieldType: ${this.fieldType}, fieldReturnType: ${this.fieldReturnType}, value: ${this.value}}`;return t.length<200?t:`Java.Field{
	holder: ${this.holder},
...
`)}}});var fn=class t{static fromBuffer(e,n){let r=ji(n),o=r.getCanonicalPath().toString(),i=new File(o,"w");return i.write(e.buffer),i.close(),Bf(o,n),new t(o,r,n)}constructor(e,n,r){this.path=e,this.file=n,this._factory=r}load(){let{_factory:e}=this,{codeCacheDir:n}=e,r=e.use("dalvik.system.DexClassLoader"),o=e.use("java.io.File"),i=this.file;if(i===null&&(i=e.use("java.io.File").$new(this.path)),!i.exists())throw new Error("File not found");o.$new(n).mkdirs(),e.loader=r.$new(i.getCanonicalPath(),n,null,e.loader),re.preventDetachDueToClassLoader()}getClassNames(){let{_factory:e}=this,n=e.use("dalvik.system.DexFile"),r=ji(e),o=n.loadDex(this.path,r.getCanonicalPath(),0),i=[],s=o.entries();for(;s.hasMoreElements();)i.push(s.nextElement().toString());return i}};function ji(t){let{cacheDir:e,tempFileNaming:n}=t,r=t.use("java.io.File"),o=r.$new(e);return o.mkdirs(),r.createTempFile(n.prefix,n.suffix+".dex",o)}function Bf(t,e){e.use("java.io.File").$new(t).setWritable(!1,!1)}function Vf(){switch(Se.state){case"empty":{Se.state="pending";let t=Se.factories[0],e=t.use("java.util.HashMap"),n=t.use("java.lang.Integer");Se.loaders=e.$new(),Se.Integer=n;let r=t.loader;return r!==null&&Zr(t,r),Se.state="ready",Se}case"pending":do Thread.sleep(.05);while(Se.state==="pending");return Se;case"ready":return Se}}function Zr(t,e){let{factories:n,loaders:r,Integer:o}=Se,i=o.$new(n.indexOf(t));r.put(e,i);for(let s=e.getParent();s!==null&&!r.containsKey(s);s=s.getParent())r.put(s,i)}function Gi(t){let e=mt.get(t);e===void 0&&(e=0),e++,mt.set(t,e)}function Hi(t){let e=mt.get(t);if(e===void 0)throw new Error(`Thread ${t} is not ignored`);e--,e===0?mt.delete(t):mt.set(t,e)}function Jf(t){return t.slice(t.lastIndexOf(".")+1)}function Wr(t,e){let n=[],r=t.getArrayLength(e);for(let o=0;o!==r;o++){let i=t.getObjectArrayElement(e,o);try{n.push(t.getTypeName(i))}finally{t.deleteLocalRef(i)}}return n}function Gf(t){let e=t.split(".");return e[e.length-1]+".java"}var Hf=4,$i=Process.pointerSize,Qr=class{ACC_PUBLIC=1;ACC_PRIVATE=2;ACC_PROTECTED=4;ACC_STATIC=8;ACC_FINAL=16;ACC_SYNCHRONIZED=32;ACC_BRIDGE=64;ACC_VARARGS=128;ACC_NATIVE=256;ACC_ABSTRACT=1024;ACC_STRICT=2048;ACC_SYNTHETIC=4096;constructor(){this.classFactory=null,this.ClassFactory=Ke,this.vm=null,this.api=null,this._initialized=!1,this._apiError=null,this._wakeupHandler=null,this._pollListener=null,this._pendingMainOps=[],this._pendingVmOps=[],this._cachedIsAppProcess=null;try{this._tryInitialize()}catch{}}_tryInitialize(){if(this._initialized)return!0;if(this._apiError!==null)throw this._apiError;let e;try{e=Ot(),this.api=e}catch(r){throw this._apiError=r,r}if(e===null)return!1;let n=new ze(e);return this.vm=n,Ni(n),Ke._initialize(n,e),this.classFactory=new Ke,this._initialized=!0,!0}_dispose(){if(this.api===null)return;let{vm:e}=this;e.perform(n=>{Ke._disposeAll(n),E.dispose(n)}),Script.nextTick(()=>{ze.dispose(e)})}get available(){return this._tryInitialize()}get androidVersion(){return Mt()}synchronized(e,n){let{$h:r=e}=e;if(!(r instanceof NativePointer))throw new Error("Java.synchronized: the first argument `obj` must be either a pointer or a Java instance");let o=this.vm.getEnv();ve("VM::MonitorEnter",o.monitorEnter(r));try{n()}finally{o.monitorExit(r)}}enumerateLoadedClasses(e){this._checkAvailable();let{flavor:n}=this.api;n==="jvm"?this._enumerateLoadedClassesJvm(e):n==="art"?this._enumerateLoadedClassesArt(e):this._enumerateLoadedClassesDalvik(e)}enumerateLoadedClassesSync(){let e=[];return this.enumerateLoadedClasses({onMatch(n){e.push(n)},onComplete(){}}),e}enumerateClassLoaders(e){this._checkAvailable();let{flavor:n}=this.api;if(n==="jvm")this._enumerateClassLoadersJvm(e);else if(n==="art")this._enumerateClassLoadersArt(e);else throw new Error("Enumerating class loaders is not supported on Dalvik")}enumerateClassLoadersSync(){let e=[];return this.enumerateClassLoaders({onMatch(n){e.push(n)},onComplete(){}}),e}_enumerateLoadedClassesJvm(e){let{api:n,vm:r}=this,{jvmti:o}=n,i=r.getEnv(),s=Memory.alloc(Hf),l=Memory.alloc($i);o.getLoadedClasses(s,l);let a=s.readS32(),c=l.readPointer(),d=[];for(let p=0;p!==a;p++)d.push(c.add(p*$i).readPointer());o.deallocate(c);try{for(let p of d){let h=i.getClassName(p);e.onMatch(h,p)}e.onComplete()}finally{d.forEach(p=>{i.deleteLocalRef(p)})}}_enumerateClassLoadersJvm(e){this.choose("java.lang.ClassLoader",e)}_enumerateLoadedClassesArt(e){let{vm:n,api:r}=this,o=n.getEnv(),i=r["art::JavaVMExt::AddGlobalRef"],{vm:s}=r;Oe(n,o,l=>{let a=Sr(c=>{let d=i(s,l,c);try{let p=o.getClassName(d);e.onMatch(p,d)}finally{o.deleteGlobalRef(d)}return!0});r["art::ClassLinker::VisitClasses"](r.artClassLinker.address,a)}),e.onComplete()}_enumerateClassLoadersArt(e){let{classFactory:n,vm:r,api:o}=this,i=r.getEnv(),s=o["art::ClassLinker::VisitClassLoaders"];if(s===void 0)throw new Error("This API is only available on Android >= 7.0");let l=n.use("java.lang.ClassLoader"),a=[],c=o["art::JavaVMExt::AddGlobalRef"],{vm:d}=o;Oe(r,i,p=>{let h=Er(u=>(a.push(c(d,p,u)),!0));vr(()=>{s(o.artClassLinker.address,h)})});try{a.forEach(p=>{let h=n.cast(p,l);e.onMatch(h)})}finally{a.forEach(p=>{i.deleteGlobalRef(p)})}e.onComplete()}_enumerateLoadedClassesDalvik(e){let{api:n}=this,r=ptr("0xcbcacccd"),o=172,i=8,l=n.gDvm.add(o).readPointer(),a=l.readS32(),d=l.add(12).readPointer(),p=a*i;for(let h=0;h<p;h+=i){let g=d.add(h).add(4).readPointer();if(g.isNull()||g.equals(r))continue;let y=g.add(24).readPointer().readUtf8String();if(y.startsWith("L")){let v=y.substring(1,y.length-1).replace(/\//g,".");e.onMatch(v)}}e.onComplete()}enumerateMethods(e){let{classFactory:n}=this,r=this.vm.getEnv(),o=n.use("java.lang.ClassLoader");return tt.enumerateMethods(e,this.api,r).map(i=>{let s=i.loader;return i.loader=s!==null?n.wrap(s,o,r):null,i})}scheduleOnMainThread(e){this.performNow(()=>{this._pendingMainOps.push(e);let{_wakeupHandler:n}=this;if(n===null){let{classFactory:r}=this,o=r.use("android.os.Handler"),i=r.use("android.os.Looper");n=o.$new(i.getMainLooper()),this._wakeupHandler=n}this._pollListener===null&&(this._pollListener=Interceptor.attach(Process.getModuleByName("libc.so").getExportByName("epoll_wait"),this._makePollHook()),Interceptor.flush()),n.sendEmptyMessage(1)})}_makePollHook(){let e=Process.id,{_pendingMainOps:n}=this;return function(){if(this.threadId!==e)return;let r;for(;(r=n.shift())!==void 0;)try{r()}catch(o){Script.nextTick(()=>{throw o})}}}perform(e){if(this._checkAvailable(),!this._isAppProcess()||this.classFactory.loader!==null)try{this.vm.perform(e)}catch(n){Script.nextTick(()=>{throw n})}else this._pendingVmOps.push(e),this._pendingVmOps.length===1&&this._performPendingVmOpsWhenReady()}performNow(e){return this._checkAvailable(),this.vm.perform(()=>{let{classFactory:n}=this;if(this._isAppProcess()&&n.loader===null){let o=n.use("android.app.ActivityThread").currentApplication();o!==null&&Zi(n,o)}return e()})}_performPendingVmOpsWhenReady(){this.vm.perform(()=>{let{classFactory:e}=this,n=e.use("android.app.ActivityThread"),r=n.currentApplication();if(r!==null){Zi(e,r),this._performPendingVmOps();return}let o=this,i=!1,s="early",l=n.handleBindApplication;l.implementation=function(d){if(d.instrumentationName.value!==null){s="late";let h=e.use("android.app.LoadedApk").makeApplication;h.implementation=function(u,g){return i||(i=!0,Wi(e,this),o._performPendingVmOps()),h.apply(this,arguments)}}l.apply(this,arguments)};let c=n.getPackageInfo.overloads.map(d=>[d.argumentTypes.length,d]).sort(([d],[p])=>p-d).map(([d,p])=>p)[0];c.implementation=function(...d){let p=c.call(this,...d);return!i&&s==="early"&&(i=!0,Wi(e,p),o._performPendingVmOps()),p}})}_performPendingVmOps(){let{vm:e,_pendingVmOps:n}=this,r;for(;(r=n.shift())!==void 0;)try{e.perform(r)}catch(o){Script.nextTick(()=>{throw o})}}use(e,n){return this.classFactory.use(e,n)}openClassFile(e){return this.classFactory.openClassFile(e)}choose(e,n){this.classFactory.choose(e,n)}retain(e){return this.classFactory.retain(e)}cast(e,n){return this.classFactory.cast(e,n)}array(e,n){return this.classFactory.array(e,n)}backtrace(e){return wr(this.vm,e)}isMainThread(){let e=this.classFactory.use("android.os.Looper"),n=e.getMainLooper(),r=e.myLooper();return r===null?!1:n.$isSameObject(r)}registerClass(e){return this.classFactory.registerClass(e)}deoptimizeEverything(){let{vm:e}=this;return Nr(e,e.getEnv())}deoptimizeBootImage(){let{vm:e}=this;return Tr(e,e.getEnv())}deoptimizeMethod(e){let{vm:n}=this;return Ir(n,n.getEnv(),e)}_checkAvailable(){if(!this.available)throw new Error("Java API not available")}_isAppProcess(){let e=this._cachedIsAppProcess;if(e===null){if(this.api.flavor==="jvm")return e=!1,this._cachedIsAppProcess=e,e;let n=new NativeFunction(Module.getGlobalExportByName("readlink"),"pointer",["pointer","pointer","pointer"],{exceptions:"propagate"}),r=Memory.allocUtf8String("/proc/self/exe"),o=1024,i=Memory.alloc(o),s=n(r,i,ptr(o)).toInt32();if(s!==-1){let l=i.readUtf8String(s);e=/^\/system\/bin\/app_process/.test(l)}else e=!0;this._cachedIsAppProcess=e}return e}};function Zi(t,e){let n=t.use("android.os.Process");t.loader=e.getClassLoader(),n.myUid()===n.SYSTEM_UID.value?(t.cacheDir="/data/system",t.codeCacheDir="/data/dalvik-cache"):"getCodeCacheDir"in e?(t.cacheDir=e.getCacheDir().getCanonicalPath(),t.codeCacheDir=e.getCodeCacheDir().getCanonicalPath()):(t.cacheDir=e.getFilesDir().getCanonicalPath(),t.codeCacheDir=e.getCacheDir().getCanonicalPath())}function Wi(t,e){let n=t.use("java.io.File");t.loader=e.getClassLoader();let r=n.$new(e.getDataDir()).getCanonicalPath();t.cacheDir=r,t.codeCacheDir=r+"/cache"}var Yr=new Qr;Script.bindWeak(Yr,()=>{Yr._dispose()});var me=Yr;var Xr={pretty:!0,structured:!1,color:!0,verbose:!0,captureCalls:!0,maxValueLength:512,maxDedupeKeys:8192,scoreThreshold:1,dartLibraryScan:!0,dartSymbolTable:!1};function se(){return Xr}function qi(t){return Object.assign(Xr,t),Xr}var Ki=Date.now(),eo=[];function fe(t,e){let n={v:1,t:Date.now()-Ki,type:t,...e};eo.push(n),se().structured&&send(n)}function to(){return eo}function _t(t){return eo.filter(e=>e.type===t).length}function Qi(){return Date.now()-Ki}var Yi={reset:"\x1B[0m",green:"\x1B[32m",yellow:"\x1B[33m",cyan:"\x1B[36m",red:"\x1B[31;1m",dim:"\x1B[2m"};function ot(t,e){return se().color?Yi[t]+e+Yi.reset:e}function it(t){se().pretty&&console.log(t)}var R={section(t){it(`
`+ot("cyan","[*] --- "+t+" ---"))},info(t){it(ot("green","[+] ")+t)},note(t){it(ot("yellow","[+] ")+t)},hit(t){it(ot("red","[!] "+t))},warn(t){it(ot("yellow","[-] ")+t)},fail(t){it(ot("red","[-] "+t))},detail(t){it(ot("dim","    "+t))}};function Ce(t,e){return t.length>=e?t:t+" ".repeat(e-t.length)}var Xi=new Set;function no(t,e){let n=e instanceof Error?e.message:String(e);Xi.has(t)||(Xi.add(t),fe("error",{where:t,message:n}),R.warn(t+": "+n))}function Q(t,e){try{return e()}catch(n){no(t,n);return}}function hn(t,e){return function(...n){try{return e.apply(this,n)}catch(r){no(t,r);return}}}function Ue(t,e,n){e.implementation=function(...r){try{n(this,r)}catch(o){no(t,o)}return e.apply(this,r)}}function es(t,e){try{return t(e)}catch{return null}}var ke=class{keys=new Set;saturated=!1;first(e){return this.keys.has(e)?!1:this.keys.size>=se().maxDedupeKeys?(this.saturated=!0,!1):(this.keys.add(e),!0)}get size(){return this.keys.size}get isSaturated(){return this.saturated}};function Be(t){if(t==null)return null;let e=se().maxValueLength;return t.length<=e?t:t.slice(0,e)+"\u2026(+"+(t.length-e)+")"}var mn={name:"default",description:"Attack-surface scoring for mobile platform-channel and method names. Weights are additive; a name matching several tags scores the sum.",ignore:["webview_flutter","firebase_core","firebase_analytics","google_mobile_ads","image_picker","path_provider","shared_preferences_android","url_launcher","package_info_plus","connectivity_plus","device_info_plus","flutter/lifecycle","flutter/system","flutter/textinput","flutter/platform","flutter/navigation","flutter/keyevent","flutter/accessibility","flutter/restoration","flutter/mousecursor","flutter/settings","flutter/skia","flutter/spellcheck"],tags:[{tag:"rasp-vendor",weight:5,note:"Named commercial RASP or hardening product. Highest-signal match.",keywords:["dexguard","promon","shield","appdome","guardsquare","talsec","freerasp","verimatrix","zimperium","appsealing","inauth","arxan","digital.ai","jscrambler","buildfire"]},{tag:"root-detect",weight:4,note:"Device-integrity and tamper checks; the usual first blocker on an engagement.",keywords:["jailbreak","jailbroken","rooted","root_check","rootcheck","rootbeer","magisk","xposed","supersu","busybox","tamper","integrity","safetynet","playintegrity","attestation","emulator","simulator","debugger","antidebug","frida","substrate","cydia","hooking","rasp"]},{tag:"pinning",weight:4,note:"Certificate validation and pinning surfaces.",keywords:["pinning","certpin","sslpin","trustmanager","trust_manager","x509","certificate","truststore","ssl","tls","mitm"]},{tag:"crypto",weight:3,note:"Key material and cryptographic operations.",keywords:["crypto","cipher","encrypt","decrypt","keystore","keychain","secretkey","privatekey","signing","signature","hmac","aes","rsa","seed","mnemonic","entropy"]},{tag:"auth",weight:3,note:"Authentication, session, and biometric gates.",keywords:["auth","login","logout","session","token","refresh_token","bearer","oauth","credential","password","passcode","pincode","biometric","fingerprint","faceid","touchid","localauth","mfa","otp","2fa"]},{tag:"storage",weight:2,note:"Local persistence where secrets tend to land.",keywords:["secure_storage","securestorage","sharedpreferences","userdefaults","sqlite","database","realm","hive","cache","vault","wallet"]},{tag:"network",weight:2,note:"Transport configuration and proxy or VPN awareness.",keywords:["proxy","vpn","http","socket","websocket","grpc","api_client","interceptor","dns"]},{tag:"payment",weight:3,note:"Payment and card handling, high-value in fintech targets.",keywords:["payment","card","pan","cvv","emv","nfc","hce","transaction","transfer","billing","purchase"]},{tag:"security-generic",weight:2,note:"Generic security naming. Deliberately low-weight: it catches in-house channels like `app/security_check` that no specific tag would, at the cost of some noise.",keywords:["security","secure","protection","protect","threat","harden","obfusc","antifraud","anti_fraud","fraud","risk"]},{tag:"native-bridge",weight:1,note:"Custom bridges are worth reading regardless of naming.",keywords:["native","bridge","platform_channel","jni","ffi","plugin"]},{tag:"pii",weight:2,note:"Direct handling of personal data.",keywords:["location","gps","contacts","camera","microphone","clipboard","screenshot","screen_capture","biometrics","identity","kyc","passport","ssn"]}]};var Wf=mn.tags.map(t=>({tag:t.tag,weight:t.weight,keywords:t.keywords.map(e=>e.toLowerCase())})),qf=mn.ignore.map(t=>t.toLowerCase());function Ze(t){let e=t.toLowerCase();if(qf.some(o=>e.includes(o)))return{score:0,tags:[],ignored:!0};let n=0,r=[];for(let o of Wf)o.keywords.some(i=>e.includes(i))&&(n+=o.weight,r.push(o.tag));return{score:n,tags:r,ignored:!1}}function We(t){return!t.ignored&&t.score>=se().scoreThreshold}var ts=mn.name;var Kf=new ke,ss=new ke,Qf=new ke,Yf=new ke,ns=new Map,gt=new Map,Xf=512;function ep(t){return me.use(t)}var tp=new ke;function st(t){let e=es(ep,t);if(e!==null)return e;let n=null;return Q("flutter/android/loader-search",()=>{me.enumerateClassLoaders({onMatch(r){if(n===null)try{r.loadClass(t),n=me.ClassFactory.get(r).use(t),tp.first("loader:"+t)&&R.detail("resolved "+t+" via "+r.$className)}catch{}},onComplete(){}})}),n}function rs(t,e){if(t==null)return null;for(let n of e)try{let r=t[n];if(r==null)continue;let o=r.value;if(o!=null)return String(o)}catch{}return null}var os=null;function is(t){if(t==null)return null;try{return os??=me.use("java.lang.System"),String(os.identityHashCode(t))}catch{return null}}function as(t,e,n){if(!t||!Kf.first(e+":"+t))return;let r=Ze(t);fe("channel",{name:t,kind:e,via:n,score:r.score,tags:r.tags});let o="["+e+"] "+t;We(r)?(R.hit(o),R.detail("score "+r.score+" \xB7 "+r.tags.join(", "))):se().verbose&&!r.ignored&&R.info(o)}function ro(t,e){if(!yt.first("ctor:"+t))return;let n=st(t);if(n===null){R.detail(t+" not present on this engine version");return}Q("flutter/android/ctor/"+e,()=>{n.$init.overloads.forEach(r=>{Ue("flutter/android/ctor/"+e,r,(o,i)=>{let s=i.find(l=>typeof l=="string");typeof s=="string"&&as(s,e,"registration")})})})}function np(){if(!yt.first("set-handler"))return;let t=st("io.flutter.plugin.common.MethodChannel");t!==null&&Q("flutter/android/set-handler",()=>{t.setMethodCallHandler.overloads.forEach(e=>{Ue("flutter/android/set-handler",e,(n,r)=>{let o=r[0];if(o==null)return;let i=rp(n);i!==null&&op(o.$className,i)})})})}function rp(t){if(t==null)return null;for(let e of["name","channel"])try{let n=t[e];if(n!==void 0&&n.value!==void 0&&n.value!==null)return String(n.value)}catch{}return null}function op(t,e){if(ns.set(t,e),!se().captureCalls||!Qf.first(t))return;let n=st(t);n===null||n.onMethodCall===void 0||Q("flutter/android/handler/"+t,()=>{n.onMethodCall.overloads.forEach(r=>{Ue("flutter/android/on-method-call",r,(o,i)=>{let s=i[0],l=i[1],a=(o!=null?ns.get(o.$className):void 0)??e,c=rs(s,["method"])??"<unknown>",d=rs(s,["_arguments","arguments"]),p=Ze(a+"/"+c);fe("call",{channel:a,method:c,args:Be(d),score:p.score,tags:p.tags});let h=a+" \u2192 "+c+"("+(Be(d)??"")+")";We(p)?R.hit(h):se().verbose&&R.note(h),l!=null&&ip(l,a,c)})})})}function ip(t,e,n){let r=is(t);if(r===null)return;if(gt.size>=Xf){let s=gt.keys().next();s.done||gt.delete(s.value)}gt.set(r,{channel:e,method:n});let o=t.$className;if(!Yf.first(o))return;let i=st(o);i!==null&&Q("flutter/android/result/"+o,()=>{let s=(l,a)=>{i[l]!==void 0&&i[l].overloads.forEach(c=>{Ue("flutter/android/result/"+a,c,(d,p)=>{let h=is(d);if(h===null)return;let u=gt.get(h);if(u===void 0)return;gt.delete(h);let g=p.length>0?p[0]:void 0,_=g==null?null:String(g);fe("result",{channel:u.channel,method:u.method,outcome:a,value:Be(_)});let y=Ze(u.channel+"/"+u.method),v="\u21B3 "+a+": "+(Be(_)??"<void>");We(y)?R.hit("    "+v):se().verbose&&R.detail(v)})})};s("success","success"),s("error","error"),s("notImplemented","notImplemented")})}function sp(){if(!yt.first("messenger"))return;let t=["io.flutter.embedding.engine.dart.DartMessenger","io.flutter.view.FlutterNativeView"];for(let e of t){let n=st(e);n!==null&&Q("flutter/android/messenger/"+e,()=>{for(let r of["send","handleMessageFromDart","dispatchMessageToQueue"])n[r]!==void 0&&n[r].overloads.forEach(o=>{Ue("flutter/android/messenger",o,(i,s)=>{let l=s.find(a=>typeof a=="string");typeof l=="string"&&as(l,"method","messenger")})})})}}function ls(t,e){if(!t||!ss.first(t))return;let n=Ze(t);fe("plugin",{name:t,source:e}),We(n)?R.hit("[plugin] "+t+"  ("+n.tags.join(", ")+")"):R.info("[plugin] "+t)}function ap(){if(!yt.first("plugin-registry"))return;let t=st("io.flutter.embedding.engine.FlutterEngineConnectionRegistry");t===null||t.add===void 0||Q("flutter/android/plugin-registry",()=>{t.add.overloads.forEach(e=>{Ue("flutter/android/plugin-add",e,(n,r)=>{let o=r[0];o!=null&&o.$className!==void 0&&ls(o.$className,"registry")})})})}function cs(){me.perform(()=>{R.section("Flutter Plugins"),Q("flutter/android/plugin-scan",()=>{me.enumerateLoadedClasses({onMatch(t){t.startsWith("io.flutter.plugins.")&&t.endsWith("Plugin")&&ls(t,"loaded-classes")},onComplete(){}})}),ss.size===0&&R.detail("no plugins seen yet \u2014 they register as the app starts up")})}var yt=new ke,ds=!1;function lp(){yt.first("retry-hook")&&Q("flutter/android/retry-hook",()=>{let t=me.use("android.app.Instrumentation");t.callApplicationOnCreate!==void 0&&t.callApplicationOnCreate.overloads.forEach(e=>{Ue("flutter/android/retry",e,()=>{ds||_n()})})})}function _n(){me.perform(()=>{let t=yt.first("section-header");if(t&&R.section("Flutter Platform Channels (Android)"),st("io.flutter.plugin.common.MethodChannel")===null){t&&R.detail("Flutter classes not loaded yet \u2014 will retry as the app starts"),lp();return}ds=!0,cp(),t||R.detail("Flutter classes resolved on retry \u2014 channel hooks installed")})}function cp(){me.perform(()=>{ro("io.flutter.plugin.common.MethodChannel","method"),ro("io.flutter.plugin.common.EventChannel","event"),ro("io.flutter.plugin.common.BasicMessageChannel","message"),np(),sp(),ap(),R.detail("Hooks installed \u2014 exercise the app to populate the model.")})}function gn(t){return t.find(e=>{let n=e.name.toLowerCase();return n==="libflutter.so"||n==="flutter"})??null}function zt(t){return t.find(e=>{let n=e.name.toLowerCase();return n==="libapp.so"||n==="app"})??null}function us(t){return t?.name??"the Dart payload"}function dp(t){let e=t.split(`
`)[0]?.trim()??t.trim(),n=/^(?:Dart (?:SDK|VM) version:\s*)?([0-9]+\.[0-9]+\.[0-9]+(?:[-+][\w.]+)?)\s*(?:\(([^)]*)\))?/.exec(e),r=/\bon\s+"([^"]+)"/.exec(e);return{sdk:n?.[1]??null,channel:n?.[2]??null,arch:r?.[1]??null,raw:e}}function up(t){return t.length>200?!1:/^dart:[a-z_][a-z0-9_]*$/.test(t)||/^package:[a-z0-9_]+$/.test(t)?!0:/^package:[a-z0-9_]+\/[A-Za-z0-9_./-]+\.dart$/.test(t)}function hs(t){return/^package:([a-z0-9_]+)(?:\/|$)/.exec(t)?.[1]??null}function fp(t){let e=[];return t.aotSnapshot&&e.push("AOT snapshot present"),t.vmServiceStrings&&e.push("VM-service strings in engine"),t.kernelBlob&&e.push("kernel blob present"),t.kernelBlob&&!t.aotSnapshot?{mode:"debug",evidence:e}:t.aotSnapshot&&t.vmServiceStrings?{mode:"profile",evidence:e}:t.aotSnapshot?{mode:"release",evidence:e}:t.vmServiceStrings?{mode:"debug",evidence:e}:{mode:"unknown",evidence:e}}var pp=["_kDartVmSnapshotData","_kDartVmSnapshotInstructions","_kDartIsolateSnapshotData","_kDartIsolateSnapshotInstructions"],bt={dartVersion:"44 61 72 74 20 53 44 4b 20 76 65 72 73 69 6f 6e 3a 20",dartVmVersion:"44 61 72 74 20 56 4d 20 76 65 72 73 69 6f 6e 3a 20",vmService:"76 6d 20 73 65 72 76 69 63 65 20 69 73 20 6c 69 73 74 65 6e 69 6e 67 20 6f 6e",observatory:"4f 62 73 65 72 76 61 74 6f 72 79 20 6c 69 73 74 65 6e 69 6e 67 20 6f 6e",packageUri:"70 61 63 6b 61 67 65 3a"},yn=4e3;function ms(t){return Q("dart/ranges",()=>t.enumerateRanges("r--"))??[]}function oo(t,e,n){let r=[];for(let o of ms(t)){if(r.length>=n)break;let i=Q("dart/scan",()=>Memory.scanSync(o.base,o.size,e))??[],s=o.base.add(o.size);for(let l of i)if(r.push({address:l.address,limit:s}),r.length>=n)break}return r}function hp(t,e,n,r){let o=Q("dart/scan-range",()=>Memory.scanSync(t,e,n))??[],i=t.add(e);return o.slice(0,r).map(s=>({address:s.address,limit:i}))}function mp(t,e,n){let r=t.add(e);return n.some(o=>{let i=o.base.add(o.size);return t.compare(o.base)>=0&&r.compare(i)<=0})}function _p(t){let e=Q("dart/version-export",()=>t.findExportByName("Dart_VersionString"));return e==null?null:Q("dart/version-call",()=>{let r=new NativeFunction(e,"pointer",[])();return r.isNull()?null:r.readCString(256)})??null}function fs(t,e,n){let r=oo(t,e,1)[0];return r===void 0?null:_s(r.address,n,r.limit)}function ps(t,e){return oo(t,e,1).length>0}function _s(t,e,n){let r=e;if(n!==void 0){let l=n.sub(t).toInt32();if(l<=0)return null;r=Math.min(e,l)}let o=Q("dart/read-printable",()=>t.readByteArray(r));if(o==null)return null;let i=new Uint8Array(o),s=0;for(;s<i.length;){let l=i[s];if(l<32||l>126)break;s++}return s===0?null:String.fromCharCode(...i.subarray(0,s))}function gp(t){let e=t.path;return typeof e!="string"||!e.startsWith("/")?!1:!e.includes("!")&&!e.includes(".apk")}function yp(t){let e=[],n=se().dartSymbolTable&&gp(t);se().dartSymbolTable&&!n&&R.detail("symbol table skipped \u2014 "+t.name+" is mapped from an archive");let r=n?Q("dart/enumerate-symbols",()=>t.enumerateSymbols()):void 0;for(let o of pp){let i=r?.find(l=>l.name===o||l.name===o.replace(/^_/,""));if(i!==void 0){e.push({name:o,address:i.address.toString(),size:i.size??null});continue}let s=Q("dart/find-export",()=>t.findExportByName(o));s!=null&&e.push({name:o,address:s.toString(),size:null})}return e}function bp(t,e){let n=new ke,r=[],o=new Set,i=e.find(c=>c.name==="_kDartIsolateSnapshotData"&&c.size!==null&&c.size>0),s=ms(t),l=i!==void 0&&i.size!==null&&mp(ptr(i.address),i.size,s),a=l&&i!==void 0&&i.size!==null?hp(ptr(i.address),i.size,bt.packageUri,yn):oo(t,bt.packageUri,yn);R.detail("scanned "+(l?"isolate snapshot data":t.name+" mappings")+" \xB7 "+a.length+" candidate(s)");for(let c of a){let d=_s(c.address,200,c.limit);if(d===null||!up(d)||!n.first(d))continue;r.push(d);let p=hs(d);p!==null&&o.add(p)}return a.length>=yn&&R.detail("library recovery capped at "+yn+" candidates"),{uris:r,packages:Array.from(o).sort()}}function gs(t){R.section("Dart Runtime");let e=gn(t),n=zt(t);if(e===null&&n===null){R.warn("No Flutter engine or Dart payload in this process \u2014 nothing to enumerate.");return}let r=null;if(e!==null){let c=_p(e)??fs(e,bt.dartVersion,256)??fs(e,bt.dartVmVersion,256);c!==null&&(r=dp(c))}let o=n!==null?yp(n):[],i=o.some(c=>c.name.endsWith("Instructions")),s=e!==null&&(ps(e,bt.vmService)||ps(e,bt.observatory)),l=fp({aotSnapshot:i||n!==null,vmServiceStrings:s,kernelBlob:!1}),a=n!==null&&se().dartLibraryScan?bp(n,o):{uris:[],packages:[]};fe("dart",{sdk:r?.sdk??null,channel:r?.channel??null,arch:r?.arch??null,versionRaw:r?.raw??null,buildMode:l.mode,buildModeEvidence:l.evidence,snapshot:o,libraryCount:a.uris.length,packages:a.packages});for(let c of a.uris)fe("dart.library",{uri:c,package:hs(c)});if(r!==null?(R.info(Ce("Dart SDK",14)+": "+(r.sdk??"unknown")),r.channel!==null&&R.detail("channel: "+r.channel+(r.arch?" \xB7 "+r.arch:""))):R.warn("Dart version string not found in the engine binary."),l.mode==="release"?R.info(Ce("Build mode",14)+": release"):l.mode==="unknown"?R.warn(Ce("Build mode",14)+": unknown"):(R.hit(Ce("Build mode",14)+": "+l.mode),R.detail("a non-release build exposes the VM service \u2014 full class and"),R.detail("function enumeration is available without snapshot parsing")),l.evidence.length>0&&R.detail("evidence: "+l.evidence.join("; ")),o.length>0){R.info(Ce("Snapshot",14)+": "+o.length+" section(s)");for(let c of o)R.detail(c.name+" @ "+c.address+(c.size!==null?" ("+c.size+" bytes)":""))}else n!==null&&R.warn(us(n)+" present but no snapshot symbols \u2014 stripped or packed.");a.packages.length>0?(R.info(Ce("Dart packages",14)+": "+a.packages.length),R.detail(a.packages.join(", ")),R.detail(a.uris.length+" library URIs recovered")):n!==null&&R.warn("No Dart library URIs recovered \u2014 snapshot may be packed or obfuscated.")}var bn=null,Dt={exceptions:"propagate"};function Ut(){if(bn!==null)return bn;let t={},e=[{module:"libsystem_malloc.dylib",functions:{free:["void",["pointer"]]}},{module:"libobjc.A.dylib",functions:{objc_msgSend:function(r){this.objc_msgSend=r},objc_msgSend_stret:function(r){this.objc_msgSend_stret=r},objc_msgSend_fpret:function(r){this.objc_msgSend_fpret=r},objc_msgSendSuper:function(r){this.objc_msgSendSuper=r},objc_msgSendSuper_stret:function(r){this.objc_msgSendSuper_stret=r},objc_msgSendSuper_fpret:function(r){this.objc_msgSendSuper_fpret=r},objc_getClassList:["int",["pointer","int"]],objc_lookUpClass:["pointer",["pointer"]],objc_allocateClassPair:["pointer",["pointer","pointer","pointer"]],objc_disposeClassPair:["void",["pointer"]],objc_registerClassPair:["void",["pointer"]],class_isMetaClass:["bool",["pointer"]],class_getName:["pointer",["pointer"]],class_getImageName:["pointer",["pointer"]],class_copyProtocolList:["pointer",["pointer","pointer"]],class_copyMethodList:["pointer",["pointer","pointer"]],class_getClassMethod:["pointer",["pointer","pointer"]],class_getInstanceMethod:["pointer",["pointer","pointer"]],class_getSuperclass:["pointer",["pointer"]],class_addProtocol:["bool",["pointer","pointer"]],class_addMethod:["bool",["pointer","pointer","pointer","pointer"]],class_copyIvarList:["pointer",["pointer","pointer"]],objc_getProtocol:["pointer",["pointer"]],objc_copyProtocolList:["pointer",["pointer"]],objc_allocateProtocol:["pointer",["pointer"]],objc_registerProtocol:["void",["pointer"]],protocol_getName:["pointer",["pointer"]],protocol_copyMethodDescriptionList:["pointer",["pointer","bool","bool","pointer"]],protocol_copyPropertyList:["pointer",["pointer","pointer"]],protocol_copyProtocolList:["pointer",["pointer","pointer"]],protocol_addProtocol:["void",["pointer","pointer"]],protocol_addMethodDescription:["void",["pointer","pointer","pointer","bool","bool"]],ivar_getName:["pointer",["pointer"]],ivar_getTypeEncoding:["pointer",["pointer"]],ivar_getOffset:["pointer",["pointer"]],object_isClass:["bool",["pointer"]],object_getClass:["pointer",["pointer"]],object_getClassName:["pointer",["pointer"]],method_getName:["pointer",["pointer"]],method_getTypeEncoding:["pointer",["pointer"]],method_getImplementation:["pointer",["pointer"]],method_setImplementation:["pointer",["pointer","pointer"]],property_getName:["pointer",["pointer"]],property_copyAttributeList:["pointer",["pointer","pointer"]],sel_getName:["pointer",["pointer"]],sel_registerName:["pointer",["pointer"]],class_getInstanceSize:["pointer",["pointer"]]},optionals:{objc_msgSend_stret:"ABI",objc_msgSend_fpret:"ABI",objc_msgSendSuper_stret:"ABI",objc_msgSendSuper_fpret:"ABI",object_isClass:"iOS8"}},{module:"libdispatch.dylib",functions:{dispatch_async_f:["void",["pointer","pointer","pointer"]]},variables:{_dispatch_main_q:function(r){this._dispatch_main_q=r}}}],n=0;return e.forEach(function(r){let o=r.functions||{},i=r.variables||{},s=r.optionals||{};n+=Object.keys(o).length+Object.keys(i).length;let l=(Process.findModuleByName(r.module)?.enumerateExports()??[]).reduce(function(a,c){return a[c.name]=c,a},{});Object.keys(o).forEach(function(a){let c=l[a];if(c!==void 0&&c.type==="function"){let d=o[a];typeof d=="function"?d.call(t,c.address):t[a]=new NativeFunction(c.address,d[0],d[1],Dt),n--}else s[a]&&n--}),Object.keys(i).forEach(function(a){let c=l[a];c!==void 0&&c.type==="variable"&&(i[a].call(t,c.address),n--)})}),n===0&&(t.objc_msgSend_stret||(t.objc_msgSend_stret=t.objc_msgSend),t.objc_msgSend_fpret||(t.objc_msgSend_fpret=t.objc_msgSend),t.objc_msgSendSuper_stret||(t.objc_msgSendSuper_stret=t.objc_msgSendSuper),t.objc_msgSendSuper_fpret||(t.objc_msgSendSuper_fpret=t.objc_msgSendSuper),bn=t),bn}var vp=`#include <glib.h>
#include <ptrauth.h>
